  ...
  var Sage = {
    ...
    'home': {
      init: function() {
        ...
        ReactDOM.render(<CalendarWidget />, document.getElementById('react-calendar'));
      },
      finalize: function() {
    ...
    'calendar': {
      init: function() {
        ...
        ReactDOM.render(<DatePicker start_date={start} end_date={end} />, document.getElementById('react-datepicker'));
        ReactDOM.render(<EventFilter event_category={event_category} />, document.getElementById('react-event-filter'));
      }
    },
    'single_exhibition': {
      init: function() {
        $('.exhibition-images a.image').featherlightGallery({
          previousIcon: '«',
          nextIcon: '»',
        });
      }
